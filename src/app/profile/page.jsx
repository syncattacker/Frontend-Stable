...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .btn-g:hover:not(:disabled) { border-color: ${T.bHover}; color: ${T.cream}; }
  .btn-g:disabled { opacity: .35; cursor: not-allowed; }

  .btn-p {
    background: ${T.cream}; border: 1px solid ${T.cream}; color: #0f0f0f;
    cursor: pointer; font-family: 'Outfit', sans-serif; font-size: 9px;
    letter-spacing: 0.18em; text-transform: uppercase; padding: 7px 14px;
    display: inline-flex; align-items: center; gap: 5px;
    transition: opacity .15s;
  }
  .btn-p:hover:not(:disabled) { opacity: .82; }
  .btn-p:disabled { opacity: .35; cursor: not-allowed; }

  .btn-d {
    background: none; border: 1px solid rgba(196,96,96,.3); color: ${T.errText};
    cursor: pointer; font-family: 'Outfit', sans-serif; font-size: 9px;
    letter-spacing: 0.18em; text-transform: uppercase; padding: 7px 14px;
    display: inline-flex; align-items: center; gap: 5px;
    transition: border-color .15s;
  }
  .btn-d:hover:not(:disabled) { border-color: ${T.errText}; }
  ...
  .ibtn:hover { border-color: ${T.bHover}; color: ${T.cream}; }
  .ibtn.danger { border-color: rgba(196,96,96,.3); color: ${T.errText}; }
  .ibtn.danger:hover { border-color: ${T.errText}; }
  ...
  .up-input:focus { border-color: rgba(255,255,255,.25); }
  .up-input::placeholder { color: rgba(136,136,136,.45); }
  ...
  .fpill {
    background: none; border: 1px solid ${T.border}; color: ${T.mid};
    cursor: pointer; font-family: 'Outfit', sans-serif; font-size: 9px;
    letter-spacing: 0.16em; text-transform: uppercase; padding: 5px 12px;
    transition: all .15s;
  }
  .fpill:hover { border-color: rgba(255,255,255,.2); color: #bbb; }
  .fpill.on { background: ${T.cream}; border-color: ${T.cream}; color: #0f0f0f; }
  ...
  /* ── Avatar upload ── */
  .av-wrap { position: relative; cursor: pointer; display: inline-block; }
  .av-overlay {
